...
if ($result->num_rows === 0) {
    die("Simulacro no encontrado o no has respondido este simulacro.");
}
...
<head>
    ...
    <title>Detalle de Respuestas - SABERQUEST</title>
    ...
    <div class="main-container">
        ...
        <div class="contenedor">
            ...
            <div class="question-card <?php echo $pregunta['es_correcta'] ? 'correct' : 'incorrect'; ?>">
                ...
                <?php
                    // Mostrar imágenes del enunciado (carrusel si hay varias)
                ...
                <div class="result-info <?php echo $pregunta['es_correcta'] ? 'correct' : 'incorrect'; ?>">
                    <i class="fas <?php echo $pregunta['es_correcta'] ? 'fa-check-circle' : 'fa-times-circle'; ?>"></i>
                    <p>
                        <strong>Tu respuesta: <?php echo strtoupper(htmlspecialchars((string)($pregunta['respuesta_usuario'] ?? ''))); ?></strong>
            ...
            <div class="locked-content">
                ...
                <p>Se ha configurado este simulacro para no mostrar el detalle de respuestas después de enviarlo.</p>
            </div>
            <?php endif; ?>
