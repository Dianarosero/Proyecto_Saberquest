...
<head>
    ...
    <title>Mis Resultados - Universidad CESMAG</title>
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="welcome-card">
            <h2>Bienvenido(a), <?php echo htmlspecialchars($nombre_usuario); ?></h2>
            <p>Aquí puedes ver los resultados de todos los formularios que has respondido.</p>
        </div>
        
        <?php if (empty($formularios_respondidos)): ?>
        <div class="empty-state">
            <i class="fas fa-clipboard-list"></i>
            <h3>No has respondido ningún formulario todavía</h3>
            <p>Los resultados de los formularios que completes aparecerán aquí.</p>
            <a href="formularios_estudiante.php" class="btn btn-primary">
                <i class="fas fa-search"></i> Explorar formularios
            </a>
        </div>
        <?php else: ?>
                ...
                <div class="card-image" style="background-image: url('<?php echo htmlspecialchars(!empty($form['imagen']) ? $form['imagen'] : 'img/default-bg.svg'); ?>')">
                    <div class="card-overlay">
                        <span class="score-badge <?php echo $form['clase_rendimiento']; ?>">
                            <?php echo $form['respuestas_correctas']; ?> / <?php echo $form['total_preguntas']; ?> correctas
                        </span>
                    </div>
                </div>
