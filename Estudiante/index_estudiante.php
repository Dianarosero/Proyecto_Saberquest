        ...
        <div class="container">
            ...
            <div class="about-content">
                <div class="about-text">
                    <p>SaberQuest nació como una iniciativa académica orientada a transformar la forma en que
                        estudiantes, docentes y administradores interactúan con el conocimiento. Desde sus inicios, la
                        plataforma fue diseñada con el propósito de ofrecer herramientas digitales innovadoras para la
                        enseñanza, la evaluación y el aprendizaje autónomo.</p>
                    <p>Con el paso del tiempo, SaberQuest ha evolucionado de un proyecto universitario a una solución
                        educativa integral que apoya la gestión de simulacros, prácticas, juegos interactivos y
                        visualización de resultados. Gracias al compromiso de un equipo multidisciplinario apasionado
                        por la educación y la tecnología, la plataforma continúa creciendo y adaptándose a las
                        necesidades del entorno académico moderno.</p>
                    <p>Hoy, SaberQuest se consolida como un espacio virtual donde el aprendizaje es dinámico, inclusivo
                        y accesible para todos, fortaleciendo las habilidades de los estudiantes y facilitando el
                        trabajo pedagógico de los docentes.</p>
                ...
                <a href="resultados/mis_resultados.php" class="project-card" data-category="Resultados">
                    ...
                    <div class="project-info">
                        ...
                        <p class="project-description">Consulta los resultados obtenidos en las diferentes actividades
                            para evaluar el progreso y desempeño como estudiante.</p>
                    </div>
                </a>
            </div>
        </div>
