        ...
        <div id="modal-eliminar-formulario" class="modal-overlay">
            <div class="modal">
                ...
                <div class="modal-content">
                    <p>¿Estás seguro de que deseas eliminar el formulario: <strong id="formulario-titulo-eliminar"></strong>?</p>
                    <p>Esta acción eliminará el formulario y todas sus preguntas. No se puede deshacer.</p>
                </div>
                <div class="modal-actions">
                    <button class="btn btn-secondary" onclick="cerrarModal('modal-eliminar-formulario')">Cancelar</button>
                    <form id="form-eliminar-formulario" method="post" action="eliminar_formulario.php" style="display:inline;">
