...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Helper: mostrar alerta de advertencia con SweetAlert2 si está disponible
  ...
  function validateCurrentPage() {
    const currentPageInputs = pages[currentPage].querySelectorAll(
      'input[type="radio"]'
    );
    ...
    if (!allQuestionsAnswered && firstUnanswered) {
      ...
      // Show alert message (SweetAlert2 si disponible)
      showWarning(
        "Respuestas incompletas",
        "Por favor, responde todas las preguntas en esta página antes de continuar."
      );
      return false;
    }
  ...
  function validateForm() {
    ...
    if (!allAnswered && firstUnanswered) {
      ...
      firstUnanswered.element.scrollIntoView({
        behavior: "smooth",
        block: "center",
      });
  ...
  function submitForm() {
    ...
    submitAnimation.innerHTML =
      '<div style="color: white; font-size: 1.5rem;"><i class="fas fa-spinner fa-spin" style="margin-right: 10px;"></i> Enviando respuestas...</div>';
